...
describe('Merchant e2e test', () => {
  ...
  it('should load Merchants', async () => {
    ...
    expect(await merchantComponentsPage.getTitle()).to.eq('myblogApp.merchant.home.title');
  ...
  it('should load create Merchant page', async () => {
    ...
    expect(await merchantUpdatePage.getPageTitle()).to.eq('myblogApp.merchant.home.createOrEditLabel');
  ...
  it('should create and save Merchants', async () => {
    ...
    await promise.all([merchantUpdatePage.userCoopcycleSelectLastOption()]);
  ...
  it('should delete last Merchant', async () => {
    ...
    expect(await merchantDeleteDialog.getDialogTitle()).to.eq('myblogApp.merchant.delete.question');
