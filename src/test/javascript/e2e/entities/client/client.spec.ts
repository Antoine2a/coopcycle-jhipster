...
describe('Client e2e test', () => {
  ...
  it('should load Clients', async () => {
    ...
    expect(await clientComponentsPage.getTitle()).to.eq('myblogApp.client.home.title');
  ...
  it('should load create Client page', async () => {
    ...
    expect(await clientUpdatePage.getPageTitle()).to.eq('myblogApp.client.home.createOrEditLabel');
  ...
  it('should create and save Clients', async () => {
    ...
    await promise.all([clientUpdatePage.setAdressInput('adress'), clientUpdatePage.userCoopcycleSelectLastOption()]);

    expect(await clientUpdatePage.getAdressInput()).to.eq('adress', 'Expected Adress value to be equals to adress');
  ...
  it('should delete last Client', async () => {
    ...
    expect(await clientDeleteDialog.getDialogTitle()).to.eq('myblogApp.client.delete.question');
